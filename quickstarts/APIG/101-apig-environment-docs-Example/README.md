...
This example is used to create a `alicloud_apig_environment` resource.
...
| [alicloud_apig_gateway.defaultgateway](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/apig_gateway) | resource |
