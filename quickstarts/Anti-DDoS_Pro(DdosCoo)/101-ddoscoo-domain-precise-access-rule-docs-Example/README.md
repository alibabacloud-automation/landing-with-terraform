...
This example is used to create a `alicloud_ddoscoo_domain_precise_access_rule` resource.
...
| Name | Type |
|------|------|
| [alicloud_ddoscoo_domain_precise_access_rule.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ddoscoo_domain_precise_access_rule) | resource |
