...
This example is used to create a `alicloud_api_gateway_log_config` resource.
...
| Name | Type |
|------|------|
| [alicloud_api_gateway_log_config.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/api_gateway_log_config) | resource |
