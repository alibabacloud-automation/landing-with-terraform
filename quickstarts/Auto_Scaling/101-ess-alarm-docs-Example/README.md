...
This example is used to create a `alicloud_ess_alarm` resource.
...
| Name | Type |
|------|------|
| [alicloud_ess_alarm.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ess_alarm) | resource |
