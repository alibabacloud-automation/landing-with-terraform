...
This example is used to create a `alicloud_ess_alb_server_group_attachment` resource.
...
| [alicloud_ess_alb_server_group_attachment.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ess_alb_server_group_attachment) | resource |
