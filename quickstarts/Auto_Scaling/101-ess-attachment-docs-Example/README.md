...
This example is used to create a `alicloud_ess_attachment` resource.
...
| Name | Type |
|------|------|
| [alicloud_ess_attachment.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ess_attachment) | resource |
