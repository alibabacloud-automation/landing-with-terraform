...
This example is used to create a `alicloud_ess_suspend_process` resource.
...
| [alicloud_ess_suspend_process.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ess_suspend_process) | resource |
