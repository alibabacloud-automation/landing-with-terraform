...
This example is used to create a `alicloud_bastionhost_host_account_user_group_attachment` resource.
...
| [alicloud_bastionhost_host_account_user_group_attachment.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/bastionhost_host_account_user_group_attachment) | resource |
