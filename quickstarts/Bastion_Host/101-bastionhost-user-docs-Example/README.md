...
This example is used to create a `alicloud_bastionhost_user` resource.
...
| [alicloud_bastionhost_user.ram_user](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/bastionhost_user) | resource |
