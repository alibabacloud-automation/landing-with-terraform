...
This example is used to create a `alicloud_cms_alarm` resource.
...
| Name | Type |
|------|------|
| [alicloud_cms_alarm.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/cms_alarm) | resource |
