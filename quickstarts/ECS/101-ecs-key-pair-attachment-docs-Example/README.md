...
This example is used to create a `alicloud_ecs_key_pair_attachment` resource.
...
| [alicloud_ecs_key_pair_attachment.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ecs_key_pair_attachment) | resource |
