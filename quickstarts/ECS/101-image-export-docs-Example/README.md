...
This example is used to create a `alicloud_image_export` resource.
...
| [alicloud_image_export.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/image_export) | resource |
