...
This example is used to create a `alicloud_ens_load_balancer_http_listener` resource.
...
| [alicloud_ens_load_balancer_http_listener.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ens_load_balancer_http_listener) | resource |
