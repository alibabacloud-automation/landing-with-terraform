...
This example is used to create a `alicloud_esa_image_transform` resource.
...
| Name | Type |
|------|------|
| [alicloud_esa_image_transform.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/esa_image_transform) | resource |
