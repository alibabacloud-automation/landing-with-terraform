...
This example is used to create a `alicloud_esa_origin_protection` resource.
...
| Name | Type |
|------|------|
| [alicloud_esa_origin_protection.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/esa_origin_protection) | resource |
