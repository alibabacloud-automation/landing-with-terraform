...
This example is used to create a `alicloud_eci_image_cache` resource.
...
| Name | Type |
|------|------|
| [alicloud_eci_image_cache.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/eci_image_cache) | resource |
