...
This example is used to create a `alicloud_eci_virtual_node` resource.
...
| Name | Type |
|------|------|
| [alicloud_eci_virtual_node.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/eci_virtual_node) | resource |
