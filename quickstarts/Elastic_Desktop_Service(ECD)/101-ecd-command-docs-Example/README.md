...
This example is used to create a `alicloud_ecd_command` resource.
...
| Name | Type |
|------|------|
| [alicloud_ecd_command.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ecd_command) | resource |
