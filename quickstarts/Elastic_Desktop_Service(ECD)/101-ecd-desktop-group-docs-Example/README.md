...
This example is used to create a `alicloud_ecd_desktop_group` resource.
...
| Name | Type |
|------|------|
| [alicloud_ecd_desktop_group.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ecd_desktop_group) | resource |
