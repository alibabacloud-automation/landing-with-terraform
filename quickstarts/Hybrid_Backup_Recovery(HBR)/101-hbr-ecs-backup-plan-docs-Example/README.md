...
This example is used to create a `alicloud_hbr_ecs_backup_plan` resource.
...
| Name | Type |
|------|------|
| [alicloud_hbr_ecs_backup_plan.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/hbr_ecs_backup_plan) | resource |
