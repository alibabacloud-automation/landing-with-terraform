...
This example is used to create a `alicloud_hbr_server_backup_plan` resource.
...
| Name | Type |
|------|------|
| [alicloud_hbr_server_backup_plan.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/hbr_server_backup_plan) | resource |
