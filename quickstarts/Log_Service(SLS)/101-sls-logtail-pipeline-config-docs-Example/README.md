...
This example is used to create a `alicloud_sls_logtail_pipeline_config` resource.
...
| [alicloud_sls_logtail_pipeline_config.example](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/sls_logtail_pipeline_config) | resource |
