...
This example is used to create a `alicloud_polardb_primary_endpoint` resource.
...
| [alicloud_polardb_primary_endpoint.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/polardb_primary_endpoint) | resource |
