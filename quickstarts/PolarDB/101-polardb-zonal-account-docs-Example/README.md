...
This example is used to create a `alicloud_polardb_zonal_account` resource.
...
| [alicloud_polardb_zonal_account.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/polardb_zonal_account) | resource |
