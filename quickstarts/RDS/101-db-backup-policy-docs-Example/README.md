...
This example is used to create a `alicloud_db_backup_policy` resource.
...
| Name | Type |
|------|------|
| [alicloud_db_backup_policy.policy](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/db_backup_policy) | resource |
