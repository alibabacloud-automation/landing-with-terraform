...
This example is used to create a `alicloud_ros_stack_instances` resource.
...
| [alicloud_ros_stack_instances.self_managed](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ros_stack_instances) | resource |
