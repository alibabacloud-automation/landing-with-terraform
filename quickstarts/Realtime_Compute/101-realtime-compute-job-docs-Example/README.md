...
This example is used to create a `alicloud_realtime_compute_job` resource.
...
| [alicloud_realtime_compute_job.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/realtime_compute_job) | resource |
