...
This example is used to create a `alicloud_ots_tunnel` resource.
...
| [alicloud_ots_tunnel.default](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/ots_tunnel) | resource |
