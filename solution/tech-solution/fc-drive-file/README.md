...
| <a name="input_common_name"></a> [common\_name](#input\_common\_name) | common\_name，通用名称 | `string` | `"file-processing"` | no |
| <a name="input_db_instance_class"></a> [db\_instance\_class](#input\_db\_instance\_class) | db\_instance\_class，RDS实例规格 | `string` | `"mysql.n2.small.2c"` | no |
...
| <a name="input_instance_type"></a> [instance\_type](#input\_instance\_type) | instance\_type，实例类型 | `string` | `"ecs.g7.large"` | no |
| <a name="input_region"></a> [region](#input\_region) | 地域 | `string` | `"cn-hangzhou"` | no |
| <a name="input_zone_id"></a> [zone\_id](#input\_zone\_id) | zone\_id，可用区 | `string` | `"cn-hangzhou-k"` | no |
<!-- END_TF_DOCS -->