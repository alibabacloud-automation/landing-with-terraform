## Introduction
<!-- DOCS_DESCRIPTION_CN -->
本示例用于实现解决方案[泛时序数据一站式分析与洞察
](https://www.aliyun.com/solution/tech-solution/lindorm-data-process)，涉及专有网络（VPC）、交换机（VSwitch）、云服务器（ECS）、云原生多模数据库 Lindorm（Lindorm）等资源的部署。
<!-- DOCS_DESCRIPTION_CN -->
...
| [alicloud_security_group_rule.security_group_security_group_ingress_0_694f6680](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/security_group_rule) | resource |
